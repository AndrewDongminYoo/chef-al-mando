...
- The exact stable Godot version.
- The matching export-template version.
- The reference iPhone and Android devices.
- The three menu fixtures.
- The 20-order fixture.
- The exact local and CI verification commands.
