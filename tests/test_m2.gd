...
const SUITES: Array[String] = [
	"res://tests/test_preparation.gd",
	"res://tests/test_space_placement.gd",
	"res://tests/test_space_ui.gd",
	"res://tests/test_m2_rules.gd",
	"res://tests/test_m2_determinism.gd",
	"res://tests/test_m2_content.gd",
	"res://tests/test_m2_ui.gd",
	"res://tests/test_service_feedback.gd"
]
