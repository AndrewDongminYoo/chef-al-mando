...
func _check_m5(directory: String) -> bool:
	...
	var valid: bool = ending_visible and screen.get("catalog_panel").visible and screen.get("ending_button").visible and screen.get("settings_panel").licenses_dialog.visible \
