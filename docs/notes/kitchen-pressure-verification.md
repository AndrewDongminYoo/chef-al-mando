...
| --------------- | --------: | --------: | ----------: | ----------: | --------: | --------: | --------: | --------: | ----------------------- |
| `hot_queue`     |        12 |      4750 |           8 |       -1850 |        12 |      5150 |        12 |      4750 | 프렙·배치·우선순위      |
...
`scripts/check.sh m4`는 콘텐츠 버전 1·2 파일의 기록 보존, 진행 중 영업 재시작, 원본 파일 비변경을 읽습니다.
...
| `scripts/check.sh m3`        | 캠페인 파동·복수 전략·무계획 격차·결정론·실제 장면            | 1,048개 검사, 실패 0 |
