...
| 영업            | 목표 제공 | 목표 손익 | 무계획 제공 | 무계획 손익 | 기준 제공 | 기준 손익 | 주요 선택               |
| --------------- | --------: | --------: | ----------: | ----------: | --------: | --------: | ----------------------- |
| `hot_queue`     |        12 |      5000 |           8 |       -1850 |        12 |      5150 | 프렙·배치·우선순위      |
| `shared_stock`  |        17 |      4000 |          15 |        2300 |        18 |      4850 | 프렙                    |
| `long_route`    |        21 |     12000 |           3 |      -10100 |        22 |     13700 | 프렙·배치               |
| `split_duties`  |        26 |     12000 |          25 |       11600 |        26 |     12350 | 프렙·담당               |
| `rush_hour`     |        23 |      8500 |          21 |        4650 |        23 |      8600 | 프렙·우선순위           |
| `final_service` |        25 |     10000 |          18 |        1500 |        26 |     10700 | 집중 프렙·배치·우선순위 |

모든 기준 전략은 같은 입력을 1배속과 4배속으로 실행했을 때 같은 최종 상태 해시를 만들어야 합니다.
...
`scripts/check.sh m3`는 모든 명시 도착 tick, 150 tick 이상의 회복 구간, 무계획 결과, 기준 전략의 통과 여유, 1배속·4배속 결정론을 읽습니다.
`scripts/check.sh m4`는 콘텐츠 버전 1 파일의 기록 보존, 진행 중 영업 재시작, 원본 파일 비변경을 읽습니다.
