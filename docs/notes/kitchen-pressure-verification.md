...
우선순위 가족을 "메뉴 세 개를 0 또는 2로"(448가지)로 넓혀 단계 1과 7을 다시 재도 최솟값은 24건·8,650원과 25건·10,100원으로 두 메뉴 가족을 넘지 못했습니다.
필요한 값(상한 18: 28건 또는 12,850원, 19–21: 29건 또는 13,750원)과 가장 가까운 최솟값(26건·10,500원)의 차이는 제공 2건·손익 2,350원이며, §5의 나머지 수단은 닿지 않습니다: 상한을 올리면 바닥이 함께 오르고(18 → 19에서 27건·12,800원 → 28건·13,700원), 실패 문장에 `insufficient_budget`이 없어 예산과 작성 발주는 쓸 수 없으며, 목표는 올리기만 합니다.
