...
| M1 headless        | 잘못된 콘텐츠, 원재료·배정·이동·마감 상태, 실제 tick 공급기, 주 화면 명령 경로 | 164개 통과                                                    |
...
최신 M1 164개, M0 25개와 export 팩 검사가 통과했고 기본 영업 결과와 두 상태 해시는 그대로입니다.
개인 계정의 프로젝트 Oracle 조회는 `[no precedent found]`였으며 선례를 가정하지 않았습니다.

## 5. 모바일 export와 남은 실기기 증거

구현 소스는 `47035f64e1b0c744061ce16fe4c3881fa08c2dae`입니다.
...
| 산출물                               | SHA-256                                                            |
| ------------------------------------ | ------------------------------------------------------------------ |
| `build/android/chef-al-mando.apk`    | `013b46ad543e7eb9d3b897a68e1ec4c7cd7b3b2d0a9554113f7494a56d6c059f` |
| `build/ios/chef-al-mando-m1.app.zip` | `5938931145614e6b3f6d3f8195ec6245b4292718e67cdcfc5025b9885c6afc0e` |
| `.app/chef_al_mando` 실행 파일       | `bb5fdd68afbf25432106723e4bdb4fb418cd01aef0ed84be71ca7de54066edcc` |
| `.app/chef_al_mando.pck` 리소스      | `dedc5907eec1f4441d15893b4e8a76e35b803803b7d6893fe647c8e14215c6ee` |
...
현재 설치 대기 산출물은 연결된 주방 검증까지 반영한 `47035f6`에서 생성했습니다.
